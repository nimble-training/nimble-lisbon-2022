...
[*Sequential Monte Carlo methods in the nimble and nimbleSMC R packages* (Michaud et al. 2021)](https://www.jstatsoft.org/article/view/v100i03)
...
See our [Journal of Statistical Software paper](https://www.jstatsoft.org/article/view/v100i03)  for discussion of the priors and transformations above.
...
Given the integration of the volatility process is not possible analytically, there are two potential approaches in NIMBLE:
  ...
  - IF2 SMC-based approach (not shown here; please our JSS paper)
