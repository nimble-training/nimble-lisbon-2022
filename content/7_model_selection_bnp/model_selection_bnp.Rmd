...
2) Explore sensitivity of the BNP model to the priors on `muTilde`, `tauTilde` or `conc`.

3) Set up a BNP generalization of the E. cervi example or in a model of your choice.
