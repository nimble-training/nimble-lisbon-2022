---
title: "NIMBLE Lisbon 2022 Workshop Overview"
subtitle: "NIMBLE Lisbon 2022 Workshop"
...
The GitHub site ([https://github.com/nimble-training/nimble-lisbon-2022](https://github.com/nimble-training/nimble-lisbon-2022)) is the main repository for materials for the modules; you can also get the individual files from GitHub. 

If you're not familiar with Git, you can get these materials by simply going to [https://github.com/nimble-training/nimble-lisbon-2022](https://github.com/nimble-training/nimble-lisbon-2022) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/nimble-training/nimble-lisbon-2022/archive/main.zip). See also slide 6 in this document for how to get them using Git or from within RStudio.
...
The workshop will be organized in modules, each of which will be a combination of lecture/demo presentation. At the end of some of the modules there will be time for you to try things out yourself. And during the modules, I expect we'll have some discussion based on questions that you ask.
...
Simply go to [https://github.com/nimble-training/nimble-lisbon-2022](https://github.com/nimble-training/nimble-lisbon-2022) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/nimble-training/nimble-lisbon-2022/archive/main.zip).

## Within RStudio

Within RStudio go to File->New Project->Version Control->Git and enter:

- "Repository URL": https://github.com/nimble-training/nimble-lisbon-2022
- "Project Directory Name": nimble-lisbon-2022 (or something else of your choosing)
...
- `git clone https://github.com/nimble-training/nimble-lisbon-2022`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/nimble-lisbon-2022`
- `git pull`
...
Here are the modules we'll work through for this short course.
 ...
 - Day 2
    ...
    - [6. Basic programming in NIMBLE](content/6_intro_nimblefunctions/intro_nimblefunctions.html)
    - [7. Model selection, including Bayesian nonparametrics](content/7_model_selection_bnp/model_selection_bnp.html)
    - [8. Programming in NIMBLE](content/8_programming/nimblefunction_programming.html)
    - [9. (first half) Spatial modeling and state-space models](content/9_spatial_models/spatial_models.html)
  
 - Day 3
    - [9. (second half) Spatial modeling and state-space models](content/9_spatial_models/spatial_models.html)
    - [10. State space model example](content/10_state_space/state_space.html)
    - [11. (extra material) Sequential Monte Carlo](content/11_smc/smc.html)
    - Discussion of workshop participants' personal projects
    - [12. Conclusions](content/12_future_directions_for_nimble/future_directions_for_nimble.html)
